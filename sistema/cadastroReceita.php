...
if ($acesso) {
    ...
    $atividade = "Acessou a página do controle de receita do contrato " . $contrato->getNumero($idContrato);
    ...
    # Nome do Modelo
    $objeto->set_nome("Controle de Aluguel");
    ...
    $objeto->set_selectLista("SELECT anoReferencia,
                                     ...
                                     tbreceita.obs,
                                     idReceita
                                FROM tbreceita LEFT JOIN tbnatureza USING (idNatureza)
    ...
    $objeto->set_label(array("Ano", "Referência", "Data", "Registro", "Valor", "Energia Elétrica", "Natureza", "Obs"));
    $objeto->set_align(array("center", "center", "center", "center", "right", "right", "center", "left"));
    $objeto->set_width(array(5, 10, 10, 10, 10, 10, 5, 30));
